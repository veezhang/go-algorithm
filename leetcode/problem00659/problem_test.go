...
func Test_maximumGap(t *testing.T) {
	funs := map[string]func(nums []int) bool{
		"isPossible1": isPossible1,
		"isPossible2": isPossible2,
		"isPossible3": isPossible3,
	}
